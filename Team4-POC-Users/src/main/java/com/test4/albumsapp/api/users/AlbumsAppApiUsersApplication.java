package com.test4.albumsapp.api.users;
...
import com.test4.albumsapp.api.users.shared.FeignErrorDecoder;
...
public class AlbumsAppApiUsersApplication {

	@Autowired
	Environment environment;
	
	public static void main(String[] args) {
		SpringApplication.run(AlbumsAppApiUsersApplication.class, args);
	}
